                                        ...
                                        <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                            <a href="javascript:void(0)" data-toggle="dropdown"
                                                ...
                                                <div class="user-avatar d-inline-block">
                                                    <img src="assets/img/profiles/ed4c5ec7-cbd3-45ba-8d4c-cddd1a42c63d.jpeg"
                            ...
                            <div class="d-block d-lg-none">
                                ...
                                <div class="offcanvas-menu" id="offcanvas_menu">
                                    ...
                                    <div class="user-menu-items px-3 m-0">
                                        <a class="px-0 pb-2 pt-0" href="{{ route('home') }}">
                                            <span class="media align-items-center">
                                                        ...
                                                        <div class="custom-breadcrumb">
                                                            <ol
                                                                ...
                                                                <li class="breadcrumb-item d-inline-block"><a
                                                                        href="/" class="text-dark">Home</a></li>
                            ...
                            <div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
                                <div class="user-info card-body">
                                    ...
                                    <div class="user-details">
                                        <h4><b>Welcome Admin MOUADEN MAALAININE</b></h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-6 align-items-center  text-center">
                                                <a href="/view-home-page"
                                                    class="{{ Request::path() === 'view-home-page' ? 'text-white active' : 'text-dark' }} p-4 first-slider-btn ctm-border-right ctm-border-left ctm-border-top"><span
                                                        class="lnr lnr-home pr-0 pb-lg-2 font-23"></span><span
                                                        class="">Homepage</span></a>
                                            </div>

                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="/view-staff-management-index"
                                                    class="{{ Request::path() === 'view-staff-management-index' ? 'text-white active' : 'text-dark' }}  p-4 second-slider-btn ctm-border-right ctm-border-top"><span
                                                        class="lnr lnr-users pr-0 pb-lg-2 font-23"></span><span
                                                        class="">Staff Management</span></a>
                                            </div>
                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="/view-leave-history"
                                                    class="{{ Request::path() === 'view-leave-history' ? 'text-white active' : 'text-dark' }}  p-4 ctm-border-right ctm-border-left"><span
                                                        class="lnr lnr-apartment pr-0 pb-lg-2 font-23"></span><span
                                                        class="">Leave Management</span></a>
                                            </div>
                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="/view-user-accounts-index"
                                                    class="{{ Request::path() === 'view-user-accounts-index' ? 'text-white active' : 'text-dark' }} p-4 ctm-border-right"><span
                                                        class="lnr lnr-calendar-full pr-0 pb-lg-2 font-23"></span><span
                                                        class="">User Accounts</span></a>
                                            </div>
                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="/view-settings-index"
                                                    class="{{ Request::path() === 'view-settings-index' ? 'text-white active' : 'text-dark' }}  p-4 ctm-border-right ctm-border-left"><span
                                                        class="lnr lnr-cog pr-0 pb-lg-2 font-23"></span><span
                                                        class="">Settings</span></a>
                                            </div>
                                            <div class="col-6 align-items-center shadow-none text-center">
                                                <a href="/handle-logout"
                                                    class="{{ Request::path() === 'handle-logout' ? 'text-white active' : 'text-dark' }}  p-4 last-slider-btn ctm-border-right"><span
                                                        class="lnr lnr-power-switch pr-0 pb-lg-2 font-23"></span><span
                                                        class="">Logout</span></a>
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-horizontal-lg">
                                    <li class="list-group-item text-center active button-5"><a
                                            href="{{ route('home') }}" class="text-white">Admin Dashboard</a></li>
